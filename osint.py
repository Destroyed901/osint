	...
	"""
        ...
        try:
            headers = {
                ...
                "Connection": "keep-alive", "Host": "iknowwhatyoudownload.com",
            ...
            for torrent in torrents:
                ...
                print(
                    f'{CYAN}[{RED}*{CYAN}] Использовано первый раз: {GREEN}{first}{CYAN}, использовано последний раз: {GREEN}{last}{CYAN}, тип торента: {GREEN}{category}{CYAN}, название торента: {GREEN}{name}{CYAN}, размер торента: {GREEN}{size}{CYAN}\n')
        except:
            print(f'{CYAN}[{RED}-{CYAN}] Не найдено')
    elif shell == '5':
        res1 = requests.get(
            'https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=1000&country=all&anonymity=elite&ssl=yes')
        ...
        try:
            ...
            print(f'{CYAN}[{RED}-{CYAN}] На найдено')
    elif shell == '7':
